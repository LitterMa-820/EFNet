...
from utils_data.data_val import test_dataset
os.environ["CUDA_VISIBLE_DEVICES"] = "0"
parser = argparse.ArgumentParser()
parser.add_argument('--testsize', type=int, default=352, help='testing size')
parser.add_argument('--pth_path', type=str, default='./sapa/V18/Net_epoch_best.pth')
opt = parser.parse_args()

for _data_name in ['CDS2K']:  # 'CAMO', 'COD10K', 'CHAMELEON'
